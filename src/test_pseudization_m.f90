...
!
module test_pseudization_m
   use dirac_m, only: ldiracfb, ldiracfs
   use schroedinger_m, only: lschfb, lschfs, lschvkbb, lschvkbbe
   use renormalize_m, only: renorm_r
   implicit none
   private
   public :: run_diag
   public :: run_diag_r
   public :: run_diag_sr_so_r
contains
...
end module test_pseudization_m
