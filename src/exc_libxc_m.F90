...
!!
module exc_libxc_m
   use exc_libxc_parser_m, only: parse_variable
   use exc_libxc_xc_messages_m, only: message, &
      messages_input_error, messages_warning, &
      messages_fatal, messages_info, &
